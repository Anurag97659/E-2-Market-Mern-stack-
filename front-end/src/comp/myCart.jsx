           ...
           <div className="w-64 h-screen fixed bg-white shadow-xl p-6 flex flex-col justify-between border-r">
             <div>
               ...
               <div className="space-y-3">
                 ...
                 <Link to="/search" className="block text-gray-700 font-medium py-3 px-4 rounded-md hover:bg-blue-100 hover:text-blue-800 transition-all flex items-center gap-2">Search ⫍‍⌕‍⫎ </Link>
            ...
            <div className="flex-1 p-8 ml-64">
                ...
                <div>
                    <p>will complete cart work later</p>
                </div>
